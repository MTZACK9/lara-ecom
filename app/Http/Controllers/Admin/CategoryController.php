...
class CategoryController extends Controller
{
    ...
    public function store(CategoryFormRequest $request)
    {
        ...
        return redirect(route('homeCategory'))->with('message', 'Categorie Added Successfully');
    }
    ...
    public function update(CategoryFormRequest $request, $category)
    {
        ...
        return redirect(route('homeCategory'))->with('message', 'Categorie Updated Successfully');
    }
}
