                                    ...
                                    <div class="col-md-12 mb-3" wire:ignore>
                                        ...
                                        <div class="d-md-flex align-items-start mt-2">
                                            <div class="nav col-md-3 flex-column nav-pills me-3 " id="v-pills-tab"
                                                ...
                                                <button class="nav-link fw-bold text-dark active"
                                                    wire:loading.attr="disabled" id="cashOnDeliveryTab-tab"
                                                    data-bs-toggle="pill" data-bs-target="#cashOnDeliveryTab"
                                                    type="button" role="tab" aria-controls="cashOnDeliveryTab"
                                                    aria-selected="true">Cash on
                                                    Delivery</button>
                                                <button class="nav-link fw-bold text-dark" id="onlinePayment-tab"
                                                    wire:loading.attr="disabled" data-bs-toggle="pill"
                                            ...
                                            <div class="tab-content col-md-9" id="v-pills-tabContent">
                                                <div class="tab-pane fade active show" id="cashOnDeliveryTab"
                                                    ...
                                                    <button type="button" wire:loading.attr="disabled"
                                                        wire:click="codOrder()" class="btn btn-warning text-white">
            ...
            @else
                <div class="row">
                    <div class="col-md-4 mx-auto">
                        <div class="card card-body shadow p-md-5">
                            <h4 class="text-center">No Items To Checkout</h4>
                            <a href="{{ route('collections') }}" class="btn btn-warning text-white my-3">Shop Now</a>
                        </div>
                    </div>
                </div>
            @endif
